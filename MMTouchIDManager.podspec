#
# Be sure to run `pod lib lint MMTouchIDManager.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'MMTouchIDManager/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MMTouchIDManager' => ['MMTouchIDManager/Assets/*.png']
  # }
